...
namespace GoPot
{
    public class JunctionPoint
    {
        ...
        public void Create(string junctionPoint, string targetDir, bool overwrite)
        {
        ...
        /// </remarks>
        /// <param name="junctionPoint">The junction point path</param>
        public void Delete(string junctionPoint)
        {
            if (!Directory.Exists(junctionPoint))
            {
        ...
        public string GetTarget(string junctionPoint)
        {
        ...
        private string InternalGetTarget(SafeFileHandle handle)
        {
        ...
        private SafeFileHandle OpenReparsePoint(string reparsePoint, EFileAccess accessMode)
        {
